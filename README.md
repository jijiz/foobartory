...
# Limitations
-It may happen that a ressource is not anymore available while robots are waiting to process their task. It would be better to get ressource before waiting time.
